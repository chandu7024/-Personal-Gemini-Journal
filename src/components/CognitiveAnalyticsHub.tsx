      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-slate-50/50 dark:bg-slate-950/50">
          ...
          {filteredEntries.length === 0 ? (
            ...
            <>
              {/* Vitality Rolling KPI Metric Cards with Equal Heights & Google Aesthetic */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-stretch">
                {/* 1. Cognitive Flexibility */}
                <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs flex flex-col justify-between relative overflow-hidden h-full group hover:border-indigo-300 dark:hover:border-indigo-700 transition-all">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                        Cognitive Flexibility
                      </span>
                      <span className="inline-flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-800/60">
                        <TrendingUp className="w-3 h-3" />
                        {auditResult?.vitalityTrends.flexibilityDelta || "+18%"}
                      </span>
                    </div>
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-3xl font-black font-display text-slate-900 dark:text-slate-100 tracking-tight">
                    ...
                    <div className="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full mt-3 overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min(100, aggregatedStats.avgFlex)}%` }}
                      />
                    </div>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-3 leading-relaxed pt-2 border-t border-slate-100 dark:border-slate-800/60">
                    Inverse of rigid thinking (*All-or-Nothing*, *Should statements*).
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs flex flex-col justify-between relative overflow-hidden h-full group hover:border-indigo-300 dark:hover:border-indigo-700 transition-all">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="inline-flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full bg-sky-50 dark:bg-sky-950/60 text-sky-600 dark:text-sky-400 border border-sky-200/60 dark:border-sky-800/60">
                        <TrendingUp className="w-3 h-3" />
                    ...
                    <div className="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full mt-3 overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min(100, aggregatedStats.avgAgency)}%` }}
                      />
                    </div>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-3 leading-relaxed pt-2 border-t border-slate-100 dark:border-slate-800/60">
                    Proportion of proactive locus of control vs. fatalistic helplessness.
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full mt-3 overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min(100, aggregatedStats.avgResilience)}%` }}
                      />
                    </div>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-3 leading-relaxed pt-2 border-t border-slate-100 dark:border-slate-800/60">
                    Recovery velocity from negative states back to calm equilibrium.
                  </p>
                </div>
              </div>
